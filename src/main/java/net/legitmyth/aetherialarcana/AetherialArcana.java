...
@Mod(AetherialArcana.MOD_ID)
public class AetherialArcana {
    public static final String MOD_ID = "aetherialarcana";
    public static final Logger LOGGER = LogUtils.getLogger();

    public AetherialArcana() {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        if(event.getTabKey() == CreativeModeTabs.INGREDIENTS) {
            event.accept(ModItems.AQUA);
            event.accept(ModItems.RAW_AQUA);
        }
    }
